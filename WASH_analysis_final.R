...
weight_fun<-strata_weight_fun
 ...
 # response$general_weights<-weight_fun(response)
...
result <- from_analysisplan_map_to_output(response_with_composites, analysisplan = analysisplan,
 ...
 name <- "20191219_new_preliminary_pop_group_aggregated_nationwide"
...
hypegrammaR::map_to_summary_table(result$results, "output/20191219_new_preliminary_pop_group_aggregated_nationwide.csv", questionnaire = questionnaire)
